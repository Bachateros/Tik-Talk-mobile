...
final now = DateTime.now();
  ...
  //     chatId: 'group_2',
  //     role: 'member',
  //     joinedAt: now.subtract(const Duration(days: 16)),
  //   ),
  ...
  //     chatId: 'group_3',
  //     role: 'member',
  //     joinedAt: now.subtract(const Duration(days: 24)),
  //   ),
  //   ParticipantEntitie(
  //     idPartic: 'p_group3_3',
  //     userId: '8',
  //     chatId: 'group_3',
  //     role: 'member',
  //     joinedAt: now.subtract(const Duration(days: 23)),
  //   ),
...
String _getMessageContent(String chatId, int messageNum) {
  ...
  Future<List<ChatEntitie?>> getChats() async {
    ...
    final userChatIds = _participiants
        .where((participant) => participant.userId == '30')
  ...
  Future<List<ChatWithLastMessageEntitie?>> getLastMessages(List<ChatEntitie?> chats) async {
    ...
    for (final chat in chats){
       ...
       lastMessages.add(ChatWithLastMessageEntitie(chat: chat!,lastMessage: chatMessages.isEmpty ? null : chatMessages.last));
    }
    return lastMessages;
  }
